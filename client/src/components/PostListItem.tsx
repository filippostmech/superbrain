...
import { Heart, Trash2, ExternalLink, Calendar, ChevronDown, ChevronUp, RefreshCw } from "lucide-react";
          ...
          <div className="flex items-center gap-1 shrink-0">
            ...
            {canEnrich && (
              <Button
                ...
                aria-label="Enrich post"
                data-testid={`button-enrich-list-${post.id}`}
              >
